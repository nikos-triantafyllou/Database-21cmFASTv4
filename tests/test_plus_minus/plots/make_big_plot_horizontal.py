...
#     print('redshiftss:', node_redshifts_fid)
#     print('xhi:', xH_global_fid)
...
#     if j==0:
#            ax[5,j].plot(hmf_mean_mass, hmf, color='black')
#            ax[5,j].set_ylabel(r'$\rm dn/dlnM [Mpc^{-3}]$')
#         #    ax[5,j].set_xlabel(r'$\rm M[M_\odot]$')
#            ax[5,j].set_yscale('log')
#            ax[5,j].set_xscale('log')

#            ax[6,j].plot(hmf_mean_mass, hmf2,color='black')
#            ax[6,j].set_ylabel(r'$\rm dn/dlnM [Mpc^{-3}]$')
#            ax[6,j].set_xlabel(r'$\rm M[M_\odot]$')
#            ax[6,j].set_yscale('log')
#            ax[6,j].set_xscale('log')

#     if j==1:
#            ax[5,j].plot(xarr3, ymean3, c='black', label=f'fiducial: {label}')
#            ax[5,j].fill_between(xarr3, ymean3-1*yerr3, ymean3+1*yerr3, alpha=0.3, label=r'$1\sigma$',color= 'black')
#         #    ax[5,j].set_xlabel(r'$\rm log_{10}(Z/Zsun)$')

#            ax[6,j].plot(xarr3_z, ymean3_z, c='black', label=f'fiducial: {label}')
#            ax[6,j].fill_between(xarr3_z, ymean3_z-1*yerr3_z, ymean3_z+1*yerr3_z, alpha=0.3, label=r'$1\sigma$',color= 'black')
#            ax[6,j].set_xlabel(r'$\rm log_{10}(Z/Zsun)$')

#     if j==3 or j==4 or j==9:
#            ax[5,j].plot(xarr1, ymean1, c='black', label=f'fiducial: {label}')
#            ax[5,j].fill_between(xarr1, ymean1-1*yerr1, ymean1+1*yerr1, alpha=0.3, label=r'$1\sigma$',color= 'black')
#         #    ax[5,j].set_xlabel(r'$\rm log_{10}(M_{halo}/M_\odot)$')

#            ax[6,j].plot(xarr1_z, ymean1_z, c='black', label=f'fiducial: {label}')
#            ax[6,j].fill_between(xarr1_z, ymean1_z-1*yerr1_z, ymean1_z+1*yerr1_z, alpha=0.3, label=r'$1\sigma$',color= 'black')
#            ax[6,j].set_xlabel(r'$\rm log_{10}(M_{halo}/M_\odot)$')


#     if j==7 or j==8:
#            ax[5,j].plot(xarr2, ymean2, c='black', label=f'fiducial: {label}')
#            ax[5,j].fill_between(xarr2, ymean2-1*yerr2, ymean2+1*yerr2, alpha=0.3, label=r'$1\sigma$',color= 'black')
#         #    ax[5,j].set_xlabel(r'$\rm log_{10}(M_\star / M_\odot)$')

#            ax[6,j].plot(xarr2_z, ymean2_z, c='black', label=f'fiducial: {label}')
#            ax[6,j].fill_between(xarr2_z, ymean2_z-1*yerr2_z, ymean2_z+1*yerr2_z, alpha=0.3, label=r'$1\sigma$',color= 'black')
#            ax[6,j].set_xlabel(r'$\rm log_{10}(M_\star / M_\odot)$')
...
for run_name in run_names:
        ...
        # if j==0:
        #         ax[5,j].plot(hmf_mean_mass, hmf, color=color)
        #         # ax[5,j].set_xlabel(r'$\rm dn/dlnM [Mpc^{-3}]$')
        #         ax[5,j].set_ylabel(r'$\rm dn/dlnM [M_\odot]$')

        # if j==1:
        #         xarr3, ymean3, yerr3 = get_mean_std_stuff(metallicity,xray_cat/sfr_cat*1e38, bins=100)
        #         ax[5,j].plot(xarr3, ymean3, c=color, label=label)
        #         ax[5,j].fill_between(xarr3, ymean3-1*yerr3, ymean3+1*yerr3, alpha=0.3, label=r'$1\sigma$',color= color)
        #         # ax[5,j].set_xlabel(r'$\rm log_{10}(Z/Zsun)$')

        # if j==3 or j==4 or j==9:
        #         xarr1, ymean1, yerr1 = get_mean_std_stuff(hm_cat, sm_cat, bins=100)
        #         ax[5,j].plot(xarr1, ymean1,  c=color, label=label)
        #         ax[5,j].fill_between(xarr1, ymean1-1*yerr1, ymean1+1*yerr1, alpha=0.3, label=r'$1\sigma$',color= color)
        #         # ax[5,j].set_xlabel(r'$\rm log_{10}(M_{halo}/M_\odot)$')


        # if j==7 or j==8:
        #         xarr2, ymean2, yerr2 = get_mean_std_stuff(sm_cat, sfr_cat, bins=100)
        #         ax[5,j].plot(xarr2, ymean2,  c=color, label=label)
        #         ax[5,j].fill_between(xarr2, ymean2-1*yerr2, ymean2+1*yerr2, alpha=0.3, label=r'$1\sigma$',color= color)
        #         # ax[5,j].set_xlabel(r'$\rm log_{10}(M_\star / M_\odot)$')
        ...
        # if j==0:
        #         ax[6,j].plot(hmf_mean_mass, hmf2, color=color)
        #         ax[6,j].set_xlabel(r'$\rm dn/dlnM [Mpc^{-3}]$')
        #         ax[6,j].set_ylabel(r'$\rm dn/dlnM [M_\odot]$')

        # if j==1:
        #         xarr3, ymean3, yerr3 = get_mean_std_stuff(metallicity,xray_cat/sfr_cat*1e38, bins=100)
        #         ax[6,j].plot(xarr3, ymean3, c=color, label=label)
        #         ax[6,j].fill_between(xarr3, ymean3-1*yerr3, ymean3+1*yerr3, alpha=0.3, label=r'$1\sigma$',color= color)
        #         ax[6,j].set_xlabel(r'$\rm log_{10}(Z/Zsun)$')

        # if j==3 or j==4 or j==9:
        #         xarr1, ymean1, yerr1 = get_mean_std_stuff(hm_cat, sm_cat, bins=100)
        #         ax[6,j].plot(xarr1, ymean1,  c=color, label=label)
        #         ax[6,j].fill_between(xarr1, ymean1-1*yerr1, ymean1+1*yerr1, alpha=0.3, label=r'$1\sigma$',color= color)
        #         ax[6,j].set_xlabel(r'$\rm log_{10}(M_{halo}/M_\odot)$')


        # if j==7 or j==8:
        #         xarr2, ymean2, yerr2 = get_mean_std_stuff(sm_cat, sfr_cat, bins=100)
        #         ax[6,j].plot(xarr2, ymean2,  c=color, label=label)
        #         ax[6,j].fill_between(xarr2, ymean2-1*yerr2, ymean2+1*yerr2, alpha=0.3, label=r'$1\sigma$',color= color)
        #         ax[6,j].set_xlabel(r'$\rm log_{10}(M_\star / M_\odot)$')
...
fig.savefig(f'{savedir}big_plus_minus_plot_small_7.pdf')