...
which python
python  /leonardo_work/CNHPC_1497299/ntriantafyllou/database/database3_venv/test_simple_run/test_simple_run.py &
psrecord $! --plot  /leonardo_work/CNHPC_1497299/ntriantafyllou/database/database3_venv/test_simple_run/psrecord_output.png --log /leonardo_work/CNHPC_1497299/ntriantafyllou/database/database3_venv/test_simple_run/psrecord_log.txt --include-children 
