# I have to add the uvlf function 
import argparse
import time
import numpy as np

parser = argparse.ArgumentParser()
parser.add_argument("--savedir", type = str, default = "/leonardo_work/CNHPC_1497299/ntriantafyllou/database/database3_venv/test_min_sampler_mass/")
parser.add_argument("--logdir", type = str, default = "/leonardo_work/CNHPC_1497299/ntriantafyllou/database/database3_venv/test_min_sampler_mass/")
parser.add_argument("--workers", type = int, default = 1)
parser.add_argument("--seed", type = int, default = 22)
parser.add_argument("--smm", type = int, default = 0)
inputs = parser.parse_args()

    
print(f'Running with smm_{inputs.smm}')

smm_array = np.load('/leonardo_work/CNHPC_1497299/ntriantafyllou/database/database3_venv/test_min_sampler_mass/smm2_arr.npy')

smm = smm_array[inputs.smm]
...
sampler_min_mass = smm                                                                                         
user_params["SAMPLER_MIN_MASS"] = sampler_min_mass       

#+
# Specify cache for specific sim                                                                
cache_path = f'/leonardo_work/CNHPC_1497299/ntriantafyllou/database/database3_venv/test_min_sampler_mass/_smm_{sampler_min_mass/1e10}_cache/'             
...
savedir = '/home/ntriantafyllou/projects/21cmFASTv4-development/smms2/'
filename = savedir+f'smm_{sampler_min_mass/1e10}_r{random_seed}.h5'       
...
savedir = '/leonardo_work/CNHPC_1497299/ntriantafyllou/database/database3_venv/test_min_sampler_mass/'
filename = savedir+f'smm_{sampler_min_mass/1e10}_r{random_seed}.h5'    
