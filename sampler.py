...
#         "SIGMA_SFR_LIM": random.uniform(0.1, 0.3),
#         "M_TURN": random.uniform(3, 6)
#     }
...
# # Loop to generate multiple parameter sets
# num_runs = 1000  # Adjust the number of runs if needed
# for i in range(num_runs):
#     all_runs[i] = generate_varying_params()
